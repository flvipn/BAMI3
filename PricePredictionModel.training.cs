...
namespace Iepan_Flaviu_Lab4
{
    public partial class PricePredictionModel
    {
        public const string RetrainFilePath =  @"C:\HDD\Facultate\An 1\Semestru 1\Covaci\Laboratoare\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=2029,MinimumExampleCountPerLeaf=29,LearningRate=0.14376397113899772,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.447518009321711,FeatureFraction=0.99999999,L1Regularization=2.7987523264413026E-10,L2Regularization=0.6499571438452996},MaximumBinCountPerFeature=308}));
